  ...
  Widget build(BuildContext context) {
    return GetBuilder<FilterController>(
      init: FilterController(
        initialValueFacilities: facilities,
        initialValueMaxPrice: maxPrice,
        initialValueMinPrice: minPrice,
        initialValueStar: star,
      ),
      builder: (controller) {
        return Scaffold(
                ...
                child: GestureDetector(
                  onTap: () {
                    final searchModel = SearchModel(
                      facilities: controller.selectedFacilities,
                      priceFrom: controller.minPrice.value.toInt(),
                      toPrice: controller.maxPrice.value.toInt(),
                      ratting: controller.selectedStar.value,
                    );
            ...
            () => GridView.builder(
              ...
              itemBuilder: (context, index) {
                ...
                return Padding(
                  ...
                  child: InkWell(
                    onTap: () => controller
                        .selectListFacilities(item.facilityName ?? ''),
                    child: Obx(
                      () => DecoratedBox(
                        decoration: BoxDecoration(
                            color: controller.selectedFacilities
                                    .contains(item.facilityName)
                                ? Colors.redAccent
                                : Colors.white,
                            borderRadius: BorderRadius.circular(12),
                            border: Border.all(color: Colors.redAccent)),
